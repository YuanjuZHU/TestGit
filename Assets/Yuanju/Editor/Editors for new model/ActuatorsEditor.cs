...
//[System.Serializable]
//public class ActuatorsEditor : Editor
//{
...
//            myTarget.path = EditorUtility.OpenFilePanel("Choose the configuration file", Application.dataPath, "csv");
//            if (myTarget.path.Length != 0)
//            {
//                var fileContent = File.ReadAllBytes(myTarget.path);
//                Debug.Log("the path of the file: "+ myTarget.path);
//            }
//            dt = ReadDataFromCsv(myTarget.path);
...
//        }
//        EditorGUILayout.TextField("file path:", myTarget.path);
